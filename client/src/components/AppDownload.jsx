...
const AppDownload = () => {
  return (
    // This div is to provide a container 
    <div className='container px-4 2xl:px-20 mx-auto my-20'>
        {/* This div is for encompassing the app main image along with two images i.e play store and app store image  */}
        <div className='relative bg-gradient-to-r from-violet-50 to-purple-50 p-12 sm:p-24 lg:p-32 rounded-lg'>
            {/* This div is encompassing the h1 tag along with two images i.e playstore and appstore */}
            <div >
                <h1 className='text-2xl sm:text-4xl font-bold mb-8 max-w-md'>Download Mobile App For Better Experience</h1>
                {/* this div is for the play store and app store image */}
